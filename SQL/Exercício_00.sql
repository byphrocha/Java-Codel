...
SELECT nome , id  FROM alunos WHERE profissao = 'Programador' AND genero ='m'; 
SELECT * FROM alunos WHERE genero = 'f' AND nome LIKE 'M%' AND localidade = 'Londrina';
SELECT nome , localidade FROM alunos WHERE nome LIKE '%Silva' AND  localidade != 'Londrina' AND peso < '100.00';

/*----------------------------------------------EXERCÍCIOS------------------------------------------------------------- */

/*01) Gerar uma lista Gerar uma lista com o nome de todas as "alunas" nascidas antes de 2000.*/
SELECT * FROM alunos WHERE genero = 'f' AND nascimento < '2000-01-01';

/*02) Gerar uma lista com o nome dos alunos(as) programadores nascidos(as) em Londrina. */
SELECT * FROM alunos WHERE profissao = 'Programador' AND localidade = 'Londrina';

/*03) Gerar uma lista com o nome de todos os alunos e alunas nascidos fora de Londrina. */
SELECT nome FROM alunos WHERE localidade != 'Londrina';

/*04) Gere uma lista de nomes que possuem em qualquer local de seu nome a letra "e". */
SELECT nome FROM alunos WHERE nome LIKE '%e%' OR '%e' OR 'e%';

/*05) Gerar uma lista com o nome e altura de todos(as) aqueles que possuem mais de 170cm. */
